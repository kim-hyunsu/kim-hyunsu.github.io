...
# Publications
(* Equal contribution)
[comment]: <> (- Joohyung Lee, Changhun Kim, **Hyunsu Kim**, Kwanhyung Lee, Juho Lee, <br>Under Review, Soft Equivariance Regularization for Invariant Self-Supervised Learning)
[comment]: <> (- Hyungi Lee, Moonseok Choi, **Hyunsu Kim**, Kyunghyun Cho, Rajesh Ranganath, Juho Lee, <br>Under Review, Test Time Scaling for Neural Processes)
[comment]: <> (- **Hyunsu Kim**, Jonggeon Park, Joan Bruna, Hongseok Yang, Juho Lee, <br>Under Review, Axial Neural Networks for Dimension-Free Foundation Models)
[comment]: <> (- Jeongjun Lee, **Hyunsu Kim**, Byoungwoo Park, Jongmin Yoon, Jonggeon Park, Deokyun Kim, JihunCha, Juho Lee, <br>Under Review, Generative Active Learning with Discriminator-Guided Diffusion for Object Detection)
